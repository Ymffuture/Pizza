    ...
    <main className="pt-24 pb-16 min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-white">
      <div className="max-w-3xl mx-auto px-6 space-y-8">
        ...
        <div className="flex justify-between text-sm text-gray-500">
          <span>
            Question {currentIndex + 1} / {total} {''} <span className="text-gray-600 bg-gray-50 dark:bg-white dark:text-black rounded-full p-2" >{Math.round(((currentIndex + 1) / total) * 100)===100? "Completed" :"In progress" }</span>
          </span>
