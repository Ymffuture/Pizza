...
/* ---------------------------------------------------
   MAIN JOB APPLICATION SCHEMA (FIXED)
--------------------------------------------------- */
export const jobApplySchema = z
  .object({
    ...
    // 🔹 MAKE ALL FILES OPTIONAL INDIVIDUALLY
